...
**Subscribe to all proplet and task metrics:**

```bash
mosquitto_sub -h localhost -p 1883 \
  -t "m/+/c/+/control/proplet/#" -v
```
...
```bash
mosquitto_sub -h localhost -p 1883 -t "m/+/c/+/control/proplet/#" -v
```
...
| Topic | Description |
| ----- | ----------- |
| [Manager](/docs/manager) | Configure task metrics storage and API endpoints |
| [Proplet](/docs/proplet) | Configure the Proplet runtime and monitoring defaults |
| [TEE](/docs/tee) | Run monitored workloads in Confidential VMs |
