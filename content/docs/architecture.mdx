...
5. **Magistrala**: Internal Event Driven Infrastructure for creation and communication between services.
...
Magistrala is an Event Driven Infrastructure (EDI) that provides:
