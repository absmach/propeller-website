...
See the [Operator overview](/docs/k8s/operator) for a full architecture description.

## Next Steps

- Follow the [step-by-step example](/docs/k8s/example) to deploy the operator and run your first WASM task end-to-end.
- Read the [Features reference](/docs/k8s/features) for the complete Custom Resource specification.
- See the [Deployment guide](/docs/k8s/deployment) for production deployment, RBAC, and configuration options.
