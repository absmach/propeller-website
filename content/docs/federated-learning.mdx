...
- [FedProx Algorithm](/docs/examples/fedprox) - Adding proximal regularization for non-IID data
- [Byzantine-Robust Aggregation](/docs/examples/byzantine-robust) - Median-based aggregation for untrusted environments
