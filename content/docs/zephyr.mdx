...
This guide covers deploying the [WebAssembly Micro Runtime (WAMR)](https://github.com/bytecodealliance/wasm-micro-runtime) on [Zephyr RTOS](https://zephyrproject.org/) for ESP32 devices. This is foundational material for running the [Embedded Proplet](/docs/embedded-proplet) on resource-constrained hardware.
...
| Topic | Description |
| ----- | ----------- |
| [Embedded Proplet](/docs/embedded-proplet) | Build and deploy a minimal Proplet for embedded devices |
| [Proplet](/docs/proplet) | Configure the full-featured Rust Proplet |
