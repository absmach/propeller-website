...
WASI-NN requires Wasmtime with the `--wasi-modules=experimental-wasi-nn` flag:
...
Use Host Runtime mode with WASI-NN support:
...
-d '{
  ...
  "image_url": "docker.io/myorg/wasi-nn-example:v1",
  "cli_args": [
    "--wasi-modules=experimental-wasi-nn",
    "--dir=fixture"
  ],
