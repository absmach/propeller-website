...
For the complete FL architecture and training lifecycle, see [Federated Learning](/docs/fml/federated-learning). For a hands-on example, see [Federated Learning Example](/docs/fml/example).
