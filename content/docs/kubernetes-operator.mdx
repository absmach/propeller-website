...
![Propeller Kubernetes Operator Architecture Overview](/docs/images/kubernetes-operator/propeller-k8s-operator-architecture.svg)
...
![MQTT Communication Flow](/docs/images/kubernetes-operator/propeller-k8s-operator-mqtt-communication.svg)
...
![Proplet Lifecycle State Machine](/docs/images/kubernetes-operator/propeller-k8s-operator-proplet-lifecycle.svg)
...
![Task Lifecycle State Machine](/docs/images/kubernetes-operator/propeller-k8s-operator-task-lifecycle.svg)
...
![Task Execution Paths](/docs/images/kubernetes-operator/propeller-k8s-operator-task-execution-paths.svg)
...
![PropellerJob Lifecycle State Machine](/docs/images/kubernetes-operator/propeller-k8s-operator-propellerjob-lifecycle.svg)
...
![FederatedJob Lifecycle State Machine](/docs/images/kubernetes-operator/propeller-k8s-operator-federatedjob-lifecycle.svg)
...
![TrainingRound Lifecycle State Machine](/docs/images/kubernetes-operator/propeller-k8s-operator-traininground-lifecycle.svg)
...
![Scheduler Algorithm](/docs/images/kubernetes-operator/propeller-k8s-operator-scheduler-algorithm.svg)
...
This renders the full deployment manifest (controller Deployment, ClusterRole, ClusterRoleBinding, ServiceAccount) via Kustomize and applies it.
