...
| `resourceRequirements.cpu`                 | string                        | No       | —          | Minimum CPU the proplet must have available (e.g. `100m`)                  |
| `resourceRequirements.memory`              | string                        | No       | —          | Minimum memory the proplet must have available (e.g. `256Mi`)              |
| `resourceRequirements.custom`              | map[string]string             | No       | —          | Custom resource constraints                                                 |
