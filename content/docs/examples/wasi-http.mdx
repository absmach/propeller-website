...
The source code is available in the [Propeller examples](https://github.com/absmach/propeller/tree/main/examples/sample-wasi-http-rust) directory (Git submodule from [bytecodealliance/sample-wasi-http-rust](https://github.com/bytecodealliance/sample-wasi-http-rust)).
