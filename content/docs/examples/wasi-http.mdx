...
The source code is available in the [Propeller examples](https://github.com/absmach/propeller/tree/main/examples) directory. The `sample-wasi-http-rust` example is a Git submodule from [bytecodealliance/sample-wasi-http-rust](https://github.com/bytecodealliance/sample-wasi-http-rust).
