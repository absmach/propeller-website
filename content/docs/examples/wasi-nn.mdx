...
- `state: 0` — Task state: 0=pending, 1=scheduled, 2=running, 3=completed, 4=failed
...
| Field        | Value              | Meaning                                                               |
| ------------ | ------------------ | --------------------------------------------------------------------- |
| `state`      | `3`                | Task completed successfully (0=pending, 1=scheduled, 2=running, 3=completed, 4=failed) |
