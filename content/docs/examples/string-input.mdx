...
[WAVE](https://github.com/bytecodealliance/wasm-tools/tree/main/crates/wasm-wave) (WebAssembly Value Encoding) is used to pass typed values to component exports. This means there are two layers of quoting:
