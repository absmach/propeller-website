...
Complete the [Federated Learning](/docs/examples/federated-learning) example first. All services (SuperMQ, Manager, Proplets, Proxy, FL demo stack) must be running and provisioned before proceeding.
