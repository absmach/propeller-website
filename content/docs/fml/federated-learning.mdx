...
For a quick start tutorial with commands and expected outputs, see the [Federated Learning Example](/docs/fml/example).
...
- [FedProx Algorithm](/docs/fml/fedprox) - Modify the WASM client to handle non-IID data with proximal regularization
- [Byzantine-Robust Aggregation](/docs/fml/byzantine-robust) - Replace FedAvg with median-based aggregation for untrusted environments
...
For detailed setup instructions, step-by-step commands, and expected outputs, see the [Federated Learning Example](/docs/fml/example).
