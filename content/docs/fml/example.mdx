...
For a comprehensive guide on federated learning architecture, motivation, and the complete training lifecycle, see the [Federated Machine Learning](/docs/fml/federated-learning) documentation.
