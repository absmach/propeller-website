...
![Scheduler Execution Flow](images/task-scheduling-execution-flow.svg)
...
![Recurring vs One-Time Lifecycle](images/task-scheduling-recurring-vs-one-time-lifecycle.svg)
