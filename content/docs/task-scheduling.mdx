...
{
  "tasks": [
    {"id": "fetch-a", "name": "fetch-source-a", "workflow_id": "...", "depends_on": [], "run_if": "success", "state": 0},
    {"id": "fetch-b", "name": "fetch-source-b", "workflow_id": "...", "depends_on": [], "run_if": "success", "state": 0},
